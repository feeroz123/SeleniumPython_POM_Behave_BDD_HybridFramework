...
class BasePage:
    ...
    def verify_element_text(self, locator_type, locator_value, text_to_check):
        element = self.get_element(locator_type, locator_value)
        return element.text.__eq__(text_to_check)
    ...
    def verify_element_display(self, locator_type, locator_value):
        element = self.get_element(locator_type, locator_value)
